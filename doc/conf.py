...
# html_theme = 'pyramid'
html_theme = "dispel4py_theme"

# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a list of options available for each theme, see the
# documentation.
html_theme_options = {
    "header_text": "dispel4py.org",
...
# of the sidebar.
html_logo = "images/DISPEL4PY_web_trans.png"
...
htmlhelp_basename = "Dispel4Pydoc"
...
texinfo_documents = [
    (
        ...
        "The University of Edinburgh",
        "dispel4py",
        "Developing workflows for data-intensive applications.",
        "Miscellaneous",
    ),
]
